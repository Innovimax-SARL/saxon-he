...
//    }
    ...
    public NumericValue floor() {
        return new BigDecimalValue(value.setScale(0, BigDecimal.ROUND_FLOOR));
    }
    ...
    public NumericValue ceiling() {
        return new BigDecimalValue(value.setScale(0, BigDecimal.ROUND_CEILING));
    }
    ...
    public NumericValue round(int scale) {
        ...
        switch (value.signum()) {
            case -1:
                return new BigDecimalValue(value.setScale(scale, BigDecimal.ROUND_HALF_DOWN));
            case 0:
                return this;
            case +1:
                return new BigDecimalValue(value.setScale(scale, BigDecimal.ROUND_HALF_UP));
            default:
                // can't happen
                return this;
        }
