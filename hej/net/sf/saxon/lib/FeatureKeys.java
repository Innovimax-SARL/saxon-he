...
// AUTO-GENERATED FROM FeatureKeys.xml - DO NOT EDIT THIS FILE
    ...
    /**
     * <p>If byte code generation is enabled, Saxon will generate byte code for frequently used constructs appearing
     ...
     * are never garbage collected). When this limit (which defaults to 10,000) is exceeded, no more byte code
...
// AUTO-GENERATED FROM FeatureKeys.xml - DO NOT EDIT THIS FILE
    ...
    /**
     * <p><code>STABLE_UNPARSED_TEXT</code>, if set, indicates that the results returned
     * by repeated calls of <code>unparsed-text()</code>, <code>unparsed-text-lines()</code>,
     * and <code>unparsed-text-available()</code> are consistent: calling these functions twice
     * during the evaluation of a stylesheet or query will return the same results.</p>
     * <p>Setting this option may be expensive because it requires that the file contents
     * be saved in memory; it is rarely necessary in practice, but is required for strict
     * conformance with the W3C specifications.</p>
     **/
...
// AUTO-GENERATED FROM FeatureKeys.xml - DO NOT EDIT THIS FILE
     ...
     * <p>In earlier Saxon releases a third value "extended" was supported, to enable
     * Saxon streaming extensions. Since nearly all these extensions found their way into
     * the W3C specification, the distinction between "standard" and "extended" became
     * meaningless, so the value "extended" has been dropped.</p>
     * <p>The value "off" causes Saxon to behave as a non-streaming processor; that is,
     * it does not analyze constructs that are declared streamable, and it processes them
     * as if streaming were not requested. This is the
     * only option available when using a Saxon version or license that does not enable
     * streaming.</p>
     * <p>The value "standard" is a misnomer. For strict adherence to W3C streamability
     * rules, set the property <code>STRICT_STREAMABILITY</code>. The streamability rules
     * applied by default are (in nearly all cases) identical to the W3C rules, but by default
     * they are applied to the expression tree after type-checking and optimization, which
     * makes some constructs streamable that would not be so otherwise.</p>
     * <p>
...
// AUTO-GENERATED FROM FeatureKeys.xml - DO NOT EDIT THIS FILE
     ...
     * <code>let $x := ./item/price return sum($x)</code> is not streamable, but the rewritten form
     * <code>sum(./item/price)</code> is.</p>
     * <p>The XSLT 3.0 specification requires conformant streaming processors to have a
     * mode of operation in which the streamability rules are enforced as they appear in
     * the spec, and this option enables this mode.</p>
     * <p>This analysis is expensive, and should only be used during development when
     * testing stylesheet code for portability. When this mode is enabled, Saxon applies
     * the streamability rules at the earliest possible stage of processing; it then
     * performs its normal type checking and optimization phases, before doing a second
     * stage of streamability analysis to construct a streamed execution plan.</p>
     **/
...
// AUTO-GENERATED FROM FeatureKeys.xml - DO NOT EDIT THIS FILE
    ...
    /**
     * <p>By default, Saxon-EE generates Java bytecode to speed up the validation of input strings
     * against user-defined simple types after the type has been used 100 times (during the life
     * of a Saxon Configuration). This threshold may be changed using this configuration option. It may
     * be useful to raise the threshold if the number of user-defined types is large, and the bytecode
     * is creating memory pressure.</p>
     **/
...
// AUTO-GENERATED FROM FeatureKeys.xml - DO NOT EDIT THIS FILE
    ...
    /**
     * <p>When trace listening is switched on (for example by using -T on the command line), this
     * file will be supplied to the trace listener to use as the output destination. If the option
     * is not supplied, trace listener output is sent to the standard error stream.</p>
     **/
...
// AUTO-GENERATED FROM FeatureKeys.xml - DO NOT EDIT THIS FILE
    ...
    /**
     * <p>The supplied <code>UnparsedTextURIResolver</code>  will be used
     * to resolve (dereference) all URIs specifed in calls to the <code>unparsed-text()</code>,
     * <code>unparsed-text-lines()</code>, and
...
// AUTO-GENERATED FROM FeatureKeys.xml - DO NOT EDIT THIS FILE
    ...
    /**
     * <p>An instance of the specified <code>UnparsedTextURIResolver</code> class will be created, and used
     * to resolve (dereference) all URIs specifed in calls to the <code>unparsed-text()</code>,
     * <code>unparsed-text-lines()</code>, and
     * <code>unparsed-text-available()</code> functions.</p>
     **/
...
// AUTO-GENERATED FROM FeatureKeys.xml - DO NOT EDIT THIS FILE
     ...
     * <p>This property has no effect as from Saxon 9.8: the version supported will always be 3.0.</p>
     **/
