...
public class NamespaceConstant {
    ...
    public static String getConventionalPrefix(String uri) {
        if (uri.equals(XSLT)) {
            return "xsl";
        } else if (uri.equals(FN)) {
            return "fn";
        } else if (uri.equals(XML)) {
            return "xml";
        } else if (uri.equals(SCHEMA)) {
            return "xs";
        } else if (uri.equals(SCHEMA_INSTANCE)) {
            return "xsi";
        } else if (uri.equals(IXSL)) {
            return "ixsl";
        } else if (uri.equals(GLOBAL_JS)) {
            return "js";
        } else if (uri.equals(SAXON)) {
            return "saxon";
        } else {
            return null;
        }
    ...
    public static String getUriForConventionalPrefix(String prefix) {
        ...
        } else if (prefix.equals("ixsl")) {
            return IXSL;
        } else if (prefix.equals("js")) {
            return GLOBAL_JS;
